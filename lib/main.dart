...
import 'package:test_feature/theme/app_theme.dart';
import 'package:test_feature/theme/custom_colors_theme.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Animated Navigation Bottom Bar'),
    );
  }
}
